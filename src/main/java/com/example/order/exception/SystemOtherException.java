...
public class SystemOtherException extends RuntimeException {
    ...
    public SystemOtherException(Integer errorCode, String errorMsg, String errorExplain) {
        super(errorMsg);
    ...
    public SystemOtherException(ExceptionEnum exceptionEnum) {
